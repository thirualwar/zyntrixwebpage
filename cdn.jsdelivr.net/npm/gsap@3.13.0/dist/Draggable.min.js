...
! function(e, t) {
    ...
    var h, f, i, a, g, x, m, v, y, t, b = "transform",
        T = b + "Origin",
        ...
        k = function _placeSiblings(e, t) {
            ...
            if (d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), n = s ? x : g, s) c ? (i = -(r = function _getCTM(e) {
                ...
                return t
            }(o) : o.getItem(0).matrix : m).a * r.x + o.c * r.y, a = o.b * r.x + o.d * r.y) : (o = new ge, i = a = 0), t && "g" === e.tagName.toLowerCase() && (i = a = 0), (c ? s : p).appendChild(n), n.setAttribute("transform", "matrix(" + o.a + "," + o.b + "," + o.c + "," + o.d + "," + (o.e + i) + "," + (o.f + a) + ")");
            else {
                if (i = a = 0, y)
                    for (o = e.offsetParent, r = e;
                        (r = r && r.parentNode) && r !== o && r.parentNode;) 4 < (f.getComputedStyle(r)[b] + "").length && (i = r.offsetLeft, a = r.offsetTop, r = 0);
                if ("absolute" !== (l = f.getComputedStyle(e)).position && "fixed" !== l.position)
    ...
    var xe, me, ve, ye, l, s, we, be, c, Te, d, Me, Ee, De, Se, _e, Xe, Ae, Le, Ce, B, R, n, Pe = 0,
        O = "transform",
        Ye = "transformOrigin",
        Ne = Array.isArray,
        ke = 180 / Math.PI,
    ...
    function Draggable(h, p) {
        ...
        function Mh(e, t) {
            var n;
            if (!u || J.isPressed || !e || !("mousedown" !== e.type && "pointerdown" !== e.type || t) && Re() - le < 30 && Ee[J.pointerEvent.type]) z && e && u && Ba(e);
            else {
                ...
                if (R = !(!y || K == U || !1 === J.vars.allowNativeTouchScrolling || J.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which)) && (K ? "y" : "x"), (z = !R && !J.allowEventDefault) && (Ba(e), za(me, "touchforcechange", Ba)), e.changedTouches ? (e = x = e.changedTouches[0], m = e.identifier) : e.pointerId ? m = e.pointerId : x = m = null, Pe++, function _addToRenderQueue(e) {
                        ...
                        scrollTo: 1
                    }, !0), J.tween = J.lockedAxis = null, !p.zIndexBoost && (Q || f || !1 === p.zIndexBoost) || (h.style.zIndex = Draggable.zIndex++), J.isPressed = !0, g = !(!p.onDrag && !J._listeners.drag), s = !(!p.onMove && !J._listeners.move), !1 !== p.cursor || p.activeCursor)
                    for (n = q.length; - 1 < --n;) xe.set(q[n], {
        ...
        var u, f, w, b, T, M, E, g, s, D, S, X, A, x, m, L, C, t, P, Y, N, v, y, k, B, R, O, I, F, c, z, d, H, n = (p.type || "x,y").toLowerCase(),
        ...
        return (t = Draggable.get(h)) && t.kill(), e.startDrag = function(e, t) {
            ...
            var n, o, r, i, a, l, s = "velocity" === e && _e ? e : $(e) && !Q ? "element" : "start";
            ...
            if (Bh(!0), Eh(), E && !pe()) {
                if (n = J.x, o = J.y, D < n ? n = D : n < S && (n = S), X < o ? o = X : o < A && (o = A), (J.x !== n || J.y !== o) && (r = !0, J.x = J.endX = n, Q ? J.endRotation = n : J.y = J.endY = o, Ah(C = !0), J.autoScroll && !J.isDragging))
                    for (La(h.parentNode), i = h, We.scrollTop = null != me.pageYOffset ? me.pageYOffset : null != de.documentElement.scrollTop ? de.documentElement.scrollTop : de.body.scrollTop, We.scrollLeft = null != me.pageXOffset ? me.pageXOffset : null != de.documentElement.scrollLeft ? de.documentElement.scrollLeft : de.body.scrollLeft; i && !l;) a = (l = Qe(i.parentNode)) ? We : i.parentNode, U && a.scrollTop > a._gsMaxScrollY && (a.scrollTop = a._gsMaxScrollY), K && a.scrollLeft > a._gsMaxScrollX && (a.scrollLeft = a._gsMaxScrollX), i = a;
