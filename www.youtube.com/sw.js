...
ytcfg.set({
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20251113.00.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en",
            "gl": "IN",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20251113.00.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/b8106bc5\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/b8106bc5\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}